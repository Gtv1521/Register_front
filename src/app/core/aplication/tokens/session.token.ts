...
import {
  SessionEntity,
  SessionInfo,
} from '../../domain/entitys/session.entity';
import { IReset } from '../../domain/interfaces/ICrud';

export const SESSION_TOKEN = new InjectionToken<
  ISession<LoginRequestDto, SigInRequestDto, SessionEntity>
>('SESSION_TOKEN');
export const SESSIONES_TOKEN = new InjectionToken<ISessionInfo<SessionInfo>>(
  'SESSIONES_TOKEN',
);
export const RESET_TOKEN = new InjectionToken<IReset>('RESET_TOKEN');
